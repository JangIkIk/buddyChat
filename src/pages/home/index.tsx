export const Home = () => {
  return (
    <div className="tw:snap-y tw:h-full tw:snap-mandatory tw:overflow-y-scroll tw:@container tw:c-text-theme-base tw:text-base">
      ...
      <div className="tw:snap-start tw:h-full tw:flex tw:flex-col tw:justify-center tw:items-center tw:gap-10 tw:m-auto tw:c-linear-base">
      ...
      <div className="tw:pt-(--header-h-base) tw:snap-start tw:h-full tw:flex tw:flex-col tw:gap-5 tw:px-4 tw:@5xl:w-[1024px] tw:m-auto">
        <h2 className="tw:font-bold tw:text-xl">이런게 가능해요!</h2>
        <div>
          <h2 className="tw:font-bold">랜덤채팅</h2>
          <p className="tw:text-service-gray tw:shadow-md tw:p-2 tw:mt-1 tw:rounded-b-lg">
        ...
        <div>
          <h2 className="tw:font-bold">그룹채팅</h2>
          <p className="tw:text-service-gray tw:shadow-md tw:p-2 tw:mt-1 tw:rounded-b-lg">
      ...
      <div className="tw:pt-(--header-h-base) tw:snap-start tw:h-full tw:px-4 tw:@5xl:w-[1024px] tw:m-auto">
